% GESexperiment_longfile_whittled.m
%
% combine these into one long file so I can run as a loop when out to
% dinner:
%
% objfuncwho.m, process_GES_hacontrolled.m,
% process_objfuncimpacts_hacontrolled.m, OSLULCtablev2_hacontrolled.m
%
% same as GESexperiment_longfile.m, but all of the extra slow parts of the
% code are cut out so I can run for a 3-D efficiency frontier figure
%
% Processed by CS O'Connell; 30 June 2014; UMN EEB/IonE
%
...
spare delHbigAm    delQbigAm  ...
    ...
    naturalveg_fraction_5min startnum endnum
...
for i=1:varyover
    ...
    for j=1:varyover
        ...
        % be in right place
        cd '/Users/oconn568/Documents/MATLAB/aa O''Connell PROJECTS/cso002_BrazilTradeOffs/SERVICES/OVERLAP/Objective Function Experiment/Version2_HectareControlled/GESmaps_hacontrolled/GES3Dfig'
        ...
        if solveGESmaps==1
            ...
            while amtnewha_running > 150000
                ...
                if amtnewha_running > 50000000
                    stepsize=500;
                elseif amtnewha_running < 2000000
                    stepsize=20;
                else
                    stepsize=100;
                end
...
OSdir = '/Users/oconn568/Documents/MATLAB/aa O''Connell PROJECTS/cso002_BrazilTradeOffs/SERVICES/OVERLAP/Objective Function Experiment/Version2_HectareControlled/GESmaps_hacontrolled/GES3Dfig/';
